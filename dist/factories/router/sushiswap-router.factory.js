...
const fleato_1 = require("../../common/tokens/fleato");
...
class SushiswapRouterFactory {
    ...
    get FLEATOTokenForConnectedNetwork() {
        return fleato_1.FLEATO.token(this._ethersProvider.provider.network.chainId);
    }
}
